...
class CustomKeycloakUserProvider extends OAuthUserProvider implements KeycloakUserProviderInterface
{
    use TraitUserRoles;
    ...
    public function loadUserByIdentifier($identifier): UserInterface
    {
        ...
        $roles = $this->extractRoles($resourceOwner->toArray(), $provider->getClientId());
