                ...
                groups: [
                    // annotations
                    {
                        ...
                        fields: [
                            ...
                            this.createMultiSelect('Transliteration', { model: 'language_transliterationType' }),
                            this.createMultiSelect('Transliteration rank', { model: 'language_transliterationRank' }),
                            this.createMultiSelect('Transliteration domain', { model: 'language_transliterationDomain' }),
                            this.createMultiSelect('Transliteration formulaicity', { model: 'language_transliterationFormulaicity' }),
                            // typography
